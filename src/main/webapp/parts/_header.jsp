                                ...
                                <li>
                                    ...
                                    <div class="uk-navbar-dropdown">
                                        <ul class="uk-nav uk-navbar-dropdown-nav">
                                            <li><a href="${pageContext.request.contextPath}/api/user-list">User List</a>
                                            </li>
                                            <li><a href="${pageContext.request.contextPath}/api/tour-list">Tour List</a>
                                            </li>
                                            <li><a href="${pageContext.request.contextPath}/api/receipt-list">Receipt List</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                    ...
                    <c:choose>
                        <c:when test="${sessionScope.user == null}">
                            <button class="uk-button uk-button-default uk-margin-small-right" type="button"
                                    uk-toggle="target: #modal-login">Sign In
                            </button>
                            <a class="uk-button uk-button-default uk-margin-small-right"
                               href="${pageContext.request.contextPath}/api/registration">Sign Up</a>
                        </c:when>
                        <c:otherwise>
                            <div class="uk-margin-medium-right">Hi, ${sessionScope.user.name}</div>
                            <a class="uk-button uk-button-default uk-margin-small-right"
                               href="${pageContext.request.contextPath}/api/profile">Profile</a>
                            <form action="${pageContext.request.contextPath}/api/logout-action" method="post">
                                <button class="uk-button uk-button-default uk-margin-small-right" type="submit">Logout
                                </button>
                            </form>
                        </c:otherwise>
                    </c:choose>
